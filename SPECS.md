...
- `/reset-password`
- `/aide` — mode d’emploi une page (création de compte, planning, inscription, voiture, matrice, calendrier, profil, installation sur l’écran d’accueil iPhone / Android), partageable par lien ; lié depuis le login et le profil
